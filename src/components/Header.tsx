        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <nav className="container mx-auto mt-4 pt-4 border-t border-white/20">
            <div className="flex flex-col gap-4">
              <a className="text-white/80 hover:text-white transition py-2 px-4 rounded-lg hover:bg-white/10" href="/#features"
                 onClick={closeMenu}>Fonctionnalités
              </a>
              <a className="text-white/80 hover:text-white transition py-2 px-4 rounded-lg hover:bg-white/10" href="#cta"
                  onClick={closeMenu}>Rejoindre la liste d'attente
              </a>
              <a className="text-white/80 hover:text-white transition py-2 px-4 rounded-lg hover:bg-white/10" href="/#faq"
